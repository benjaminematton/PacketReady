...
- [ ] Phase 3 — in progress, slices 1–6 of 10 landed 2026-05-25. Document store + blob + prompts + four Sonnet extractors shipped; `evals/results/baseline.json` flipped to `stub: false` with 100% per-field accuracy across all 5 packets × 22 fields. Path B intake + aggregator + score-path rewire remain (slices 7–8). See [phase-3-extractors.md](./impl/phase-3-extractors.md).
