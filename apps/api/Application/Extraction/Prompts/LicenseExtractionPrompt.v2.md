...
5. `taxonomyCode` is the NUCC taxonomy code printed on the license (typically labeled "NUCC Taxonomy Code" or "Taxonomy Code"). Codes are 10 characters, alphanumeric, ending in `X` (e.g. `207R00000X` for Internal Medicine). If the license doesn't print a taxonomy code, return null — do NOT guess from the specialty name.
...
```json
{
  "fields": {
    ...
    "taxonomyCode":  { "value": "207R00000X",          "page": 1, "bbox": [120, 480, 140, 22] }
  },
  "confidence": {
